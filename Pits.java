...
public class Pits {
	...
	public static void main(String[] args) {
		...
		int pitsNumber = in.nextInt();
		for(int i=0;i<pitsNumber;i++){
			System.out.println("Enter The Pits Position"+i);
			int pitRow = in.nextInt();
			int pitcol = in.nextInt();
		}
		...
		int smallesetSteps = miningGold(visited, startRow, startCol, targetRow, targetCol, stepCount, count);
